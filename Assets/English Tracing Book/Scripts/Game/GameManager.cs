...
//	public ParticleEmitter completeEffect;
	...
	public GameObject SparklePartical;
	...
	void Start(){
		...
		UIEvents.Instance.ResetGame();

		if (TableShape.selectedShape.ID == 1)
		{
	...
	void Update ()
	{
		...
		if (Input.GetMouseButtonDown (0)) {
			...
			ResetPath ();
			SparklePartical.SetActive(false);
		}
	...
	private void RadialFill ()
	{
		...
		SparklePartical.SetActive(true);
		SparklePartical.transform.position = new Vector2(clickPostion.x, clickPostion.y);
		CheckPathComplete ();
	}
	...
	private void LinearFill ()
	{
		...
		pathFillImage.fillAmount = fillAmount;
		print("FIlllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll");
		SparklePartical.SetActive(true);
		SparklePartical.transform.position = new Vector2(clickPostion.x, clickPostion.y);
		CheckPathComplete ();
	}
	...
	{
		if (TableShape.selectedShape.ID % 5 == 0 && TableShape.selectedShape.ID != 0)
		{
			AdManager.Instance.ShowInterstitialAd(() =>
			{
				...
				if (allDone)
				{
					...
					timer.Stop();
					print(TableShape.selectedShape.ID);
					if (TableShape.selectedShape.ID < 26)
					{
						Area.Show();
						winDialog.Show();
					}
					...
					{
						UIEvents.Instance.ResetGame();
						PlayerPrefs.SetInt("TracingTicket", 1);
						//GameManagerOwn.instance.TracingTicket.transform.GetChild(1).gameObject.SetActive(false);

						FinalWinManager.instance.FinalWinShow();
						print("LAST WIN--------------------------------------------------------------------------------------------------------- PANEL");
					}
