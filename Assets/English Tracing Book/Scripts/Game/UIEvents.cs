...
public class UIEvents : MonoBehaviour
{
	...
	public void NextClickEvent()
	{
		try
		{
			...
			{
				GameManager.Instance.PreviousBtn.SetActive(true);
			}
		}
	...
	public void PreviousClickEvent()
	{
		try
		{
			...
			if (TableShape.selectedShape.ID == 1)
			{
				GameManager.Instance.PreviousBtn.SetActive(false);
			}
		}
		catch (System.Exception ex)
		{
	...
	public void HomeBTN()
	{
		SceneManager.LoadScene("Game/Scenes/GameScene");
	}
	public void RestartBTN()
	{
		SceneManager.LoadScene("English Tracing Book/Scenes/UppercaseAlbum");
	}
